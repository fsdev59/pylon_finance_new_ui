...
export const ABI_VAULT = [
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "checkTime", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "uint32", name: "_delayDuration", type: "uint32" },
    ],
    name: "setDelayDuration",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "uint32", name: "_feePermill", type: "uint32" }],
    name: "setFeePermill",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "bool", name: "_withdrawable", type: "bool" }],
